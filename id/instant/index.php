	...
	<main class="wrapper">
						...
						<div class="col">
							<div class="detail-spek">
								...
								<p class="text-capitalize mb-5 opacity-75">
									Berat Bersih<br><?php echo $data['weight'] ?> gram
								</p>
								<div class="marketplace">
									<a href="<?php echo $data['lazada SG'] ?>" target="_blank" class="text-decoration-none me-3 <?php echo $lazadaSG ?>">
										<img src="<?php echo $ucafe ?>assets/img/marketplace/lazada.svg" width="26" height="auto">
									</a>
									<a href="<?php echo $data['shopee SG'] ?>" target="_blank" class="text-decoration-none me-3 <?php echo $shopeeSG ?>">
										<img src="<?php echo $ucafe ?>assets/img/marketplace/shopee.svg" width="26" height="auto">
									</a>
									<a href="<?php echo $data['tokopedia SG'] ?>" target="_blank" class="text-decoration-none me-3 <?php echo $tokopediaSG ?>">
										<img src="<?php echo $ucafe ?>assets/img/marketplace/tokopedia.svg" width="26" height="auto">
									</a>
									<a href="<?php echo $data['bukalapak SG'] ?>" target="_blank" class="text-decoration-none me-3 <?php echo $bukalapakSG ?>">
										<img src="<?php echo $ucafe ?>assets/img/marketplace/bukalapak.svg" width="26" height="auto">
									</a>
									<a href="<?php echo $data['blibli SG'] ?>" target="_blank" class="text-decoration-none me-3 <?php echo $blibliSG ?>">
										<img src="<?php echo $ucafe ?>assets/img/marketplace/blibli.svg" width="26" height="auto">
									</a>
									<a href="<?php echo $data['jd SG'] ?>" target="_blank" class="text-decoration-none me-3 <?php echo $jdSG ?>">
		...
		<section class="related-produk text-center" style="background-color: #252525; padding-bottom: 4rem;">
			<div class="container">
				...
				<div id="carousel1" class="carousel slide produk-slider" data-bs-ride="true">
					<div class="carousel-inner">
						<?php
								...
								<div class="col">
									<div class="card card-produk">
										...
										<div class="card-body">
											...
											<p class="card-text"><?php echo $data['weight']; ?> <span>gr</span></p>
										</div>
									</div>
								</div>
							</div>
